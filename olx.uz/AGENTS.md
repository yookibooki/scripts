...
- Library `src/lib.rs` — shared utilities (`fetch_json`, `strip_html`, `format_price`, `extract_id`, `data_dir`, `ApiResponse`)
...
- Fields: `id`, `url`, `title`, `description`, `price`, `category_type`, `city`, `district`, `region`, `last_refresh_time`
