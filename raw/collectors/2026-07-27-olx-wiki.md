...
`~/.local/share/olx/state.json`: `{"version":1,"max_id":65506057,"initial_complete":true,"known_categories":[1,2,3,36,37,317,571,899,891,903,1151,1153,1632]}`
...
# systemd timer (every 30 min): olx-watch.service (oneshot) + olx-watch.timer (OnCalendar=*:0/30)
```
