...
| 2026-07-26 | Corrected to sequential (removed 5-thread concurrency → 429); fixed serde camelCase + deliveryOptions type; added bugs section, performance measurements, token expiry notes |
